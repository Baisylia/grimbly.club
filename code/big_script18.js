...
const commonSplashes = [
  ...
  "Time to go hero!",
  "Stupid watch!",
  "I had not fully considered that fact!",
  "My car!!",
  "I sense I've made a mistake of some kind!",
  "Think like a galvan guys!",
  "This guy's the worst!",
  "Let me tell you something custom-made Techadon robot designed specifically to destroy me!",
  "You can hurt me!",
  "You can hurt the things I stand for!",
  "You can even hurt my feelings if I had any!",
  "But no one - and I mean NO ONE - hurts the smoothie!!!",
  ...
  "Grandfather, keep them safe!",
  "Try a little fusion cuisine, by Atomix!",
  "Ha-me-naa ha-me-naa ha-me-naa ha-me-naa! Nuclear Winner!",
  "Wall of Sound!",
  "Echo Chamber!",
  "Sonic Doom!",
  ...
  "No! No beginning to feel, no reflective gonzo journalism, and no demonic possession!",
  ...
  // Charlie the Unicorn
  "CSI Miami let's go to the beach!",
  "The choo-choo shoe!",
  ...
  "Stop feeling dread, so there can be good times ahead!",
  "Is this blood also mine?",
  "Starfish loves you!",
  "Put a banana in your ear!",
  "This is the temple of the cat!",
  ...
  "The dreaded letter Y!",
  "Look, there's a banana peel on it!",
  "Owls are bugs!",
  "Rule 1: Party all the time!",
  "Rule 2: Cocaine everywhere!",
  "Rule 3: Business lunch!",
  "That is a very upsetting bat!",
  "My father is dead!",
  "I don't know how to deal with you when you're like this!",
  ...
  "BUT NOW, I NEED A LITTLE [Genorisity]",
  ...
  "When the happy heart is smiling, and the sun is shining bright!",
  ...
  "When your cat is slowly sighing, and its fur is looking white!",
  ...
  "When the sleepy duck is crying, and the mom is kiss goodnight!",
  "Raise up your bat for baseball delight!",
  "When your pancake's slowly frying, and your future's really bright!",
  ...
  "Ten feet twenty, the Flower Man, is waiting for the touch of his hand!",
  "Straightening petals out without a plan!",
  "Like the every daily wish that bothers the Flower Man!",
  "Could I do something to make him laugh?",
  "Inside my little chamber made of glass!",
  "So he lived the Flower Man, Flower Man, with his heart in the sand!",
  "So he stands, to watch the whole wide world from a can!",
  ...
  "Yet the every daily hope that powered the Flower Man would never cower off of its path!",
  ...
  "Ja-Orange!",
  "Ja-st kidding!",
  "She's a Mew Mew gal with a Mew Mew filled day!",
  "If I cross hell it'll be OK, Pretty revolution!",
  "The world spinning, last remaining rhythm!",
  "She's saving the day, Mew Mew help me!",
  "She's a Mew Mew gal who is ready to play!",
  "If I kiss with full power it'll be OK, Kitty revolution!",
  "World slaughter, this time underwater!",
  "She is saving the day, isn't it cold in here?",
  "She is saving the day, I don't know the lyrics!",
  "Lеt's use Cutie Mew Mеw Magic to transform!",
  "To the sweet you, foolish with you not!",
  "Hear my grumpy singing voice!",
  "Mew ray, Mew ray, Cutie spark!",
  "But with a firm heart, be filled with cute determination!",
  "Cutie Twin, Kitty too, To save you!",
  "Nya～, Nyan, Nya～, Nyan, Nya～, Nya～n, Nya～n, Nyan, Nya～, Nyan, Nya～, Nyan, Nya～n, Nya～n, Nyan!"
];
